...
enum TaskManagerTimePickerType { date, time, dateTime, dateTimeSeparate }

class TaskManagerTime extends FormField<String> {
  TaskManagerTime({
    Key? key,
    this.type = TaskManagerTimePickerType.date,
    this.controller,
    this.firstDate,
    this.lastDate,
    this.initialDate,
    ...
    ScrollPhysics? scrollPhysics,
        ...
        assert(type == TaskManagerTimePickerType.time || firstDate != null),
        assert(type == TaskManagerTimePickerType.time || lastDate != null),
        assert(maxLines > 0),
  ...
  final TaskManagerTimePickerType type;
...
class _DateTimePickerState extends FormFieldState<String> {
  ...
  @override
  TaskManagerTime get widget => super.widget as TaskManagerTime;
  ...
  void initValues() {
    ...
    if (lsValue != null && lsValue != '' && lsValue != 'null') {
      if (widget.type != TaskManagerTimePickerType.time) {
        ...
        if (widget.dateMask != null && widget.dateMask != '') {
          ...
          if (widget.type == TaskManagerTimePickerType.dateTime &&
              _sTime != '') {
  ...
  @override
  void didUpdateWidget(TaskManagerTime oldWidget) {
  ...
  Future<void> _showDatePickerDialog() async {
    ...
    if (ldDatePicked != null) {
      ...
      if (widget.type == TaskManagerTimePickerType.dateTimeSeparate &&
          _sTime != '') {
